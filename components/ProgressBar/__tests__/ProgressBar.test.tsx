...
describe('ProgressBar', () => {
  ...
  it('handles completed and remaining props', () => {
    const component = <ProgressBar progress={0.48} completed={12} remaining={13} />;
  ...
  it('handles showPercentage prop', () => {
    const withPercentage = <ProgressBar progress={0.65} showPercentage={true} />;
    const withoutPercentage = <ProgressBar progress={0.65} showPercentage={false} />;
